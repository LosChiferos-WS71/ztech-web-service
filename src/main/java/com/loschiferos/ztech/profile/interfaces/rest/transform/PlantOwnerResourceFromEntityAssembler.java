...
public class PlantOwnerResourceFromEntityAssembler {
    public static PlantOwnerResource toResourceFromEntity(PlantOwner entity) {
        return new PlantOwnerResource(entity.getId(), entity.getProfile().name(), entity.getProfile().email(), entity.getProfile().password(), entity.getProfile().address(), entity.getProfile().phone(), entity.getProfile().photo(), entity.getDni(), entity.getBirthday(), entity.getGender());
    }
}
